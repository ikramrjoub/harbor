        ...
        <div class="row">
            ...
            <div class="col-md-10 offset-md-1">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h3>All Contacts</h3>
                    <a href="add-cnotact.php" class="btn btn-success">
                        Add new
                    </a>
                </div>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                            <a class="btn btn-sm btn-info" href="edit-contact.php?id=<?= $contact['id'] ?>">
                            <i class="fa-solid fa-pen-to-square"></i>
                            </a>
                            <a class="btn btn-sm btn-danger" href="../user/handlers/db.php?action=deletecontacts&id=<?= $contact['id'] ?>">
