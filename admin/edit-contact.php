...
$id=$_GET['id'];
$contacts= getOnce("contacts","id=$id");
?>
    ...
    <div class="container py-5">
        <div class="row">
            ...
            <div class="col-md-6 offset-md-3">
                <h3 class="mb-3">Edit Contacts</h3>
                <div class="card">
                    <div class="card-body p-5">
                        <form action="../user/handlers/db.php" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                              ...
                              <input type="hidden" name="id" value="<?= $contacts['id'] ?>" class="form-control">
                            </div>
                            <div class="form-group">
                              <label>Icon</label>
                              <input type="text" name="icon" value="<?= $contacts['icon'] ?> " class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <select name="status" class="form-control">
                                  <option value="1"<?php if($contacts['status']==1){ ?> selected <?php } ?> >active</option>
                                  <option value="0"<?php if($contacts['status']==0){ ?> selected <?php } ?>>not active</option>
                                  
                                </select>
                            </div>
                            <div class="text-center mt-5">
                                <button name="editcontacts" type="submit" class="btn btn-primary">Edit</button>
                                <a class="btn btn-dark" href="contacts.php">Back</a>
                            </div>
                        </form>
                    </div>
                </div>
