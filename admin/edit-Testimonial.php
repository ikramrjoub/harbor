...
$id=$_GET['id'];
$testimonials= getOnce("testimonials","id=$id");
?>
    ...
    <div class="container py-5">
        <div class="row">
            ...
            <div class="col-md-6 offset-md-3">
                <h3 class="mb-3">Edit Testimonials</h3>
                <div class="card">
                    <div class="card-body p-5">
                        <form action="../user/handlers/db.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <textarea  name= "description1" class="form-control"  rows="3"><?= $testimonials['description1'] ?></textarea>
                            </div>
                            <div class="form-group">
                                <label>Description Tow</label>
                                <textarea  name= "description2" class="form-control"  rows="3"><?= $testimonials['description2'] ?></textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="status" class="form-control">
                                  <option value="1"<?php if($testimonials['status']==1){ ?> selected <?php } ?> >active</option>
                                  <option value="0"<?php if($testimonials['status']==0){ ?> selected <?php } ?>>not active</option>
                                  
                                </select>
                            </div>
                            <div class="text-center mt-5">
                                <button name="editTestimonial" type="submit" class="btn btn-primary">Edit</button>
                                <a class="btn btn-dark" href="testimonials.php">Back</a>
                            </div>
                        </form>
                    </div>
                </div>
