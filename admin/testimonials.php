        ...
        <div class="row">
            ...
            <div class="col-md-10 offset-md-1">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <a href="add-testimonials-.php" class="btn btn-success">
                        Add new
                    </a>
                </div>
                ...
                <table class="table table-hover">
                    <thead>
                      <tr>
                        ...
                        <th scope="col">Description Tow</th>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?= $testimonial['description1'] ?></td>
                        <td><?= $testimonial['description2'] ?></td>
                        ...
                        <td>
                            <a class="btn btn-sm btn-info" href="edit-Testimonial.php?id=<?= $testimonial['id'] ?>">
                            <i class="fa-solid fa-pen-to-square"></i>
                            </a><br/><br/>
                            <a class="btn btn-sm btn-danger" href="../user/handlers/db.php?action=deleteTestimonial&id=<?= $testimonial['id'] ?>">
