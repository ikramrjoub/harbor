                    ...
                    <div class="card-body p-5">
                        <form action="../user/handlers/db.php" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                              ...
                              <input type="hidden" name="id" value="<?= $works['id'] ?>" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Description</label>
                                <textarea  name= "description" class="form-control"  rows="3"><?= $works['description'] ?></textarea>
                            </div>
                            <div class="form-group">
                              <label for="customFile">Choose Image</label>
                              <img src="../user/<?= $works['img'] ?>" class="w-25"/>
                            ...
                            <div class="form-group">
                                ...
                                <select name="status" class="form-control">
                                  <option value="1"<?php if($works['status']==1){ ?> selected <?php } ?> >active</option>
                                  <option value="0"<?php if($works['status']==0){ ?> selected <?php } ?>>not active</option>
                                  
                                </select>
                            </div>
                            <div class="text-center mt-5">
                                <button name="editwork" type="submit" class="btn btn-primary">Edit</button>
