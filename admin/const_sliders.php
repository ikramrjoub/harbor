...
$const_sliders = getAll('const_sliders');
        ...
        <div class="row">
            ...
            <div class="col-md-10 offset-md-1">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h3>All Const_sliders</h3>
                    <a href="add-const_sliders.php" class="btn btn-success">
                        Add new
                    </a>
                </div>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                      <?php foreach($const_sliders as $index=>$const_slider): ?>
                      <tr>
                        <th scope="row"><?= $index +1 ?></th>
                        <td><?= $const_slider['title'] ?></td>
                        <td><?= $const_slider['description'] ?></td>
                        <td><?= $const_slider['link'] ?></td>
                        <td><?php if($const_slider['status']==1){
                          echo "Active";
                        }elseif($const_slider['status']==0){
                            echo "Not active";
                          }
                        ?></td>
                        <td><?= date("F j Y g:i a", strtotime($const_slider['created_at']))  ?></td>
                        <td>
                            <a class="btn btn-sm btn-info" href="edit-const-sliders.php?id=<?= $const_slider['id'] ?>">
                            <i class="fa-solid fa-pen-to-square"></i>
                            </a><br/><br/>
                            <a class="btn btn-sm btn-danger" href="../user/handlers/db.php?action=deleteconst_slider&id=<?= $const_slider['id'] ?>">
