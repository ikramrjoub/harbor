    ...
    <div class="container py-5">
        <div class="row">
            ...
            <div class="col-md-6 offset-md-3">
                <h3 class="mb-3">Edit About Us</h3>
                <div class="card">
                    <div class="card-body p-5">
                        <form action="../user/handlers/db.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <textarea  name= "description" class="form-control"  rows="3"><?= $aboutus['description'] ?></textarea>
                            </div>
                            
                            <div class="text-center mt-5">
                                <button name="editaboutus" type="submit" class="btn btn-primary">Edit</button>
                                <a class="btn btn-dark" href="aboutus.php">Back</a>
                            </div>
                        </form>
                    </div>
                </div>
