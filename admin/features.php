        ...
        <div class="row">
            ...
            <div class="col-md-10 offset-md-1">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h3>All Features</h3>
                    <a href="add-feature.php" class="btn btn-success">
                        Add new
                    </a>
                </div>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        ?></td>
                        <td><?= date("F j Y g:i a", strtotime($feature['created_at']))  ?></td>
                        <td>
                            <a class="btn btn-sm btn-info" href="edit-features.php?id=<?= $feature['id'] ?>">
                            <i class="fa-solid fa-pen-to-square"></i>
                            </a>
                            <a class="btn btn-sm btn-danger" href="../user/handlers/db.php?action=deletefeatures&id=<?= $feature['id'] ?>">
