        ...
        <div class="row">
            ...
            <div class="col-md-10 offset-md-1">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h3>All Works</h3>
                    <a href="add-work.php" class="btn btn-success">
                        Add new
                    </a>
                </div>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?= $work['title'] ?></td>
                        <td><img src="../user/<?= $work['img'] ?> " class='w-25'></td>
                        ...
                        ?></td>
                        <td><?= date("F j Y g:i a", strtotime($work['created_at']))  ?></td>
                        <td>
                            <a class="btn btn-sm btn-info" href="edit-work.php?id=<?= $work['id'] ?>">
                            <i class="fa-solid fa-pen-to-square"></i>
                            </a><br/><br/>
                            <a class="btn btn-sm btn-danger" href="../user/handlers/db.php?action=deleteWork&id=<?= $work['id'] ?>">
